...
export default function BentoGrid({ items, className = '' }: BentoGridProps) {
  const getSizeClasses = (size: string) => {
    const baseClasses = "flex items-center gap-3 p-4 bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:bg-purple-50 border cursor-pointer group magnetic-pull hover-highlight";
