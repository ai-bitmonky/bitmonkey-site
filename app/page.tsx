                  ...
                  return (
                    ...
                    >
                      ...
                      {servicesDropdownOpen && (
                        <div className="absolute top-full left-0 transform -translate-x-[30%] mt-2 w-[1000px] bg-white rounded-xl shadow-xl border border-gray-200 py-6 pl-6 pr-0 z-50">
