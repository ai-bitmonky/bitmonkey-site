                  ...
                  return (
                    ...
                    >
                      ...
                      {servicesDropdownOpen && (
                        <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-[1000px] bg-white rounded-xl shadow-xl border border-gray-200 py-6 pl-6 pr-0 z-50">
