            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-white/8 backdrop-blur-md rounded-2xl p-5 md:p-6 relative w-full border border-white/20 shadow-lg hover:bg-white/12 transition-all duration-300 overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-br before:from-purple-500/10 before:to-pink-500/10 before:rounded-2xl before:pointer-events-none" style={{paddingLeft: '0.75rem'}}>
                ...
                <ul className="divide-y divide-white/20">
                  ...
                  <li><button onClick={() => handleLeftNav('cloud-engineering')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-purple-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-md flex items-center justify-center"><Cloud className="w-3 h-3 text-white" /></div>Cloud Engineering</button></li>
                  <li><button onClick={() => handleLeftNav('ai-ml-automation')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-purple-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-green-500 to-teal-500 rounded-md flex items-center justify-center"><Brain className="w-3 h-3 text-white" /></div>AI-ML & Automation</button></li>
                  <li><button onClick={() => handleLeftNav('data-analytics')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-purple-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-orange-500 to-red-500 rounded-md flex items-center justify-center"><Database className="w-3 h-3 text-white" /></div>Data & Analytics</button></li>
                  <li><button onClick={() => handleLeftNav('devsecops')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-purple-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-red-500 to-pink-500 rounded-md flex items-center justify-center"><Shield className="w-3 h-3 text-white" /></div>DevSecOps</button></li>
                  <li><button onClick={() => handleLeftNav('quality-assurance')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-purple-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-md flex items-center justify-center"><TestTube className="w-3 h-3 text-white" /></div>Quality Assurance</button></li>
                  <li><button onClick={() => handleLeftNav('sre-operations')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-purple-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-md flex items-center justify-center"><Server className="w-3 h-3 text-white" /></div>SRE & Operations</button></li>
                  <li><button onClick={() => handleLeftNav('center-of-excellence')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-purple-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-teal-500 to-blue-500 rounded-md flex items-center justify-center"><Award className="w-3 h-3 text-white" /></div>Center Of Excellence</button></li>
                </ul>
              </div>
              ...
              <div className="bg-white/8 backdrop-blur-md rounded-2xl p-5 md:p-6 relative w-full border border-white/20 shadow-lg hover:bg-white/12 transition-all duration-300 overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-br before:from-blue-500/10 before:to-indigo-500/10 before:rounded-2xl before:pointer-events-none" style={{paddingLeft: '0.75rem'}}>
                ...
                <ul className="divide-y divide-white/20">
                  ...
                  <li><button onClick={() => handleLeftNav('enterprise-architecture')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-blue-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-purple-500 to-pink-500 rounded-md flex items-center justify-center"><Building className="w-3 h-3 text-white" /></div>Enterprise Architecture</button></li>
                  <li><button onClick={() => handleLeftNav('digital-strategy-roadmaps')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-blue-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-green-500 to-teal-500 rounded-md flex items-center justify-center"><Map className="w-3 h-3 text-white" /></div>Digital Strategy & Roadmaps</button></li>
                  <li><button onClick={() => handleLeftNav('governance')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-blue-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-orange-500 to-red-500 rounded-md flex items-center justify-center"><Settings className="w-3 h-3 text-white" /></div>Governance</button></li>
                  <li><button onClick={() => handleLeftNav('cloud-advisory')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-blue-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-md flex items-center justify-center"><Cloud className="w-3 h-3 text-white" /></div>Cloud Advisory</button></li>
                  <li><button onClick={() => handleLeftNav('security-compliance')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-blue-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-red-500 to-pink-500 rounded-md flex items-center justify-center"><Lock className="w-3 h-3 text-white" /></div>Security & Compliance</button></li>
                </ul>
              </div>
              ...
              <div className="bg-white/8 backdrop-blur-md rounded-2xl p-5 md:p-6 relative w-full border border-white/20 shadow-lg hover:bg-white/12 transition-all duration-300 overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-br before:from-green-500/10 before:to-teal-500/10 before:rounded-2xl before:pointer-events-none" style={{paddingLeft: '0.75rem'}}>
                ...
                <ul className="divide-y divide-white/20">
                  <li><button onClick={() => handleLeftNav('full-stack-developer')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-green-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-md flex items-center justify-center"><Code className="w-3 h-3 text-white" /></div>Full‑Stack Developer</button></li>
                  <li><button onClick={() => handleLeftNav('devops-engineer')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-green-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-md flex items-center justify-center"><Settings className="w-3 h-3 text-white" /></div>DevOps Engineer</button></li>
                  ...
                  <li><button onClick={() => handleLeftNav('ai-ml-engineer')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-green-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-orange-500 to-red-500 rounded-md flex items-center justify-center"><Brain className="w-3 h-3 text-white" /></div>AI/ML Engineer</button></li>
                  <li><button onClick={() => handleLeftNav('certifications')} className="flex items-center gap-2 p-3 text-base text-gray-900 hover:text-green-900 hover:bg-white/8 rounded-lg transition-all duration-300 relative z-10 w-full text-left"><div className="w-5 h-5 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-md flex items-center justify-center"><GraduationCap className="w-3 h-3 text-white" /></div>Certifications</button></li>
                </ul>
              </div>
            </div>
            </aside>
